...
def train(model_config: ModelConfig, train_config: TrainConfig) -> nn.Module:
    ...
    logger.info(
        ...
        n_train_examples, steps_per_epoch, train_config.batch_size,
    )
    ...
    for step in range(start_step, train_config.max_steps):
        ...
        if step % train_config.log_interval == 0:
            ...
            eta_seconds = steps_remaining / steps_per_sec if steps_per_sec > 0 else float("inf")
    ...
    logger.info(
        ...
        final_val_loss, _format_duration(total_elapsed),
    )
